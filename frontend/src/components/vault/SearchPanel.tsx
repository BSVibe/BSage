    ...
    <div className="mb-2">
      <div className="relative">
        ...
        <input
          ...
          className="w-full pr-8 py-1.5 text-xs bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md focus:outline-none focus:ring-1 focus:ring-green-500 text-gray-700 dark:text-gray-300 placeholder-gray-400"
        />
        {isActive && (
          <button
            onClick={() => setQuery("")}
          ...
          {!searching &&
            results.map((r) => (
              <button
                ...
                className="w-full text-left px-2 py-1.5 text-xs hover:bg-gray-100 dark:hover:bg-gray-700/50 rounded transition-colors"
              >
                ...
                {r.matches.length > 0 && (
                  <p className="mt-0.5 text-[10px] text-gray-400 dark:text-gray-500 truncate pl-4.5">
                    {r.matches[0].text}
                  </p>
                )}
              </button>
